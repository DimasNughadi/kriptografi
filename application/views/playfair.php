                ...
                <div class="row">
                    <div class="col-12 col-lg-12">
                        <div class="icon-box">
                            ...
                            <h4><a href="playfair.php">PlayFair Chiper</a></h4>
                                ...
                                <div class="row">
                                    <div id="wrapper" class="col-xs-6 col-xs-4 col-sm-offset-4">
                                        <div class="form-group">
                                            ...
                                            <input id="key" type="text" class="form-control" placeholder="Enter key"
                                                required>
                                            <br>
                                            <label class="control-label">Word or string:</label>
                                            <input id="String" type="text" class="form-control otstup"
                                                placeholder="Enter a word or string">
                                            <br>
                                            <div>
                                                <button class="btn btn-primary "
                                                    onclick="processKey(), cipher()">Encrypt</button>
                                            </div>
                                            <br>
                                            <div>
                                            ...
                                            <button class="btn btn-success "
                                                onclick="deCodeCipher()">Decrypt</button>
                                        </div>
                                        <br>
                                        <div>
