    					...
    					<li>
    						...
    						<div class="content">
    							<p>Enkripsi adalah proses teknis yang mengonversikan informasi menjadi kode rahasia, sehingga
    								mengaburkan data yang Anda kirim, terima, atau simpan. Pada dasarnya, sebuah algoritme digunakan
    								untuk mengacak data, sebelum pihak penerima memulihkan kembali data yang diacak tersebut menggunakan
    								kunci dekripsi. Pesan yang telah dipulihkan di dalam file yang tidak terenkripsi ini disebut sebagai
    								"plaintext", sementara dalam bentuk terenkripsi pesan itu disebut sebagai "ciphertext".</p>
    						</div>
    					</li>
    				</ul>
    			</div>
    			<div class="col-md-4" id="div1.1" style="display:none;">
    				<ul class="accordion">
    					<li>
    						<a>Caesar Chiper</a>
    						<div class="content">
    							<p>Caesar Chiper adalah algoritma kriptografi klasik yang dahulu digunakan oleh Julius Caesar untuk
    					...
    					<li>
    						<a>Aturan</a>
    						<div class="content">
    							<p>C = E (P) = (P + K) mod 26<br><br>Jadi huruf chiper pada algoritma Caesar adalah hasil pergeseran
    								sekian huruf dari huruf asli.<br><br>Contohnya "A" dengan kunci 3 akan berubah menjadi "D"</p>
    						</div>
    					</li>
    					<li>
    						<a>Komponen</a>
    					...
    					<li>
    						<a>Kelemahan</a>
    						<div class="content">
    							<p>Caesar cipher mudah dipecahkan dengan exhaustive key search karena jumlah kuncinya sangat sedikit
    								(hanya ada 26 kunci).</p>
    						</div>
    					</li>
    				</ul>
    			</div>
    			<div class="col-md-4" id="div2.2" style="display:none;">
    				<ul class="accordion">
    					...
    					<li>
    						<a>Aturan</a>
    						<div class="content">
    							<p>Menganalisa himpunan deret huruf yang memiliki index kemunculan paling sering dalam
    								ciphertext.<br><br>ci= (pi + kr)mod 26<br><br>pi = (ci - kr) mod 26</p>
    						</div>
    					</li>
    					<li>
    						<a>Komponen</a>
    					...
    					<li>
    						<a>Kelemahan</a>
    						<div class="content">
    							<p>Algoritma Vigenere Cipher memiliki kelemahan yaitu adanya perulangan karakter sehingga mudah
    								diserang dengan analisis frekuensi dan metode kaskisi.</p>
    						</div>
    					</li>
    				</ul>
    			</div>
    			<div class="col-md-4" id="div3.3" style="display:none;">
    				<ul class="accordion">
    					<li>
    						<a>Hill Cipher</a>
    						<div class="content">
    							<p>Hill Cipher menggunakan teknik perkalian matriks dan teknik invers terhadap matriks. Kunci pada
    								Hill Cipher adalah matriks n x n dengan n merupakan ukuran blok.</p>
    						</div>
    					</li>
    					<li>
    						<a>Aturan</a>
    						<div class="content">
    							<p>Hill Cipher menggunakan teknik perkalian matriks dan teknik invers terhadap matriks. Kunci pada
    								Hill Cipher adalah matriks n x n dengan n merupakan ukuran blok.<br><br>Matriks K yang menjadi kunci
    								ini harus merupakan matriks yang invertible, yaitu memiliki inverse K-1 sehingga:<br>Kunci harus
    								memiliki invers karena matriks K-1 tersebut adalah kunci yang digunakan untuk melakukan dekripsi.
    							</p>
    						</div>
    					</li>
    					<li>
    					...
    					<li>
    						<a>Kelemahan</a>
    						<div class="content">
    							<p>Hill Cipher merupakan algoritma yang hanya bisa bekerja pada 26 karakter alfabet. Selain itu,
    								jumlah karakter cipherteks sama<br><br>Dengan jumlah karakter plainteks dan juga cipherteks yang
    								dihasilkan hanya dalam karakter abjad, sehingga mudah bagi kriptanalis untuk memecahkannya.</p>
    						</div>
    					</li>
    				</ul>
    			</div>
    			<div class="col-md-4" id="div4.4" style="display:none;">
    				<ul class="accordion">
    					<li>
    						<a>Transposisi</a>
    						<div class="content">
    							<p>Ciphereteks diperoleh dengan mengubah posisinya. Dengan kata lain, algoritma ini melakukan
    								transpose terhadap rangkaian karakter di dalam teks.</p>
    						</div>
    					</li>
    					<li>
    						<a>Aturan</a>
    						<div class="content">
    							<p>- Menggunakan permutasi huruf.<br><br>- Kunci dibentuk dari penukaran satu huruf dengan huruf lain
    								pada plaintext<br><br>- Dalam 1 kalimat, huruf-huruf dibagi terlabuh dahulu menjadi beberapa
    								kelompok, dimana masing-masing kelompok memiliki jumlah huruf yang sama yaitu sesuai dengan nilai
    								kunci.</p>
    						</div>
    					</li>
    					<li>
    					...
    					<li>
    						<a>Kelemahan</a>
    						<div class="content">
    							<p>Cipher Transposisi, serumit apapun kita melakukan transposisi atau permutasi pada karakter-karakter
    								dalam plainteks, kita hanya melakukan mengacak urutan dari plainteks, tidak merubahnya. </p>
    						</div>
    					</li>
    				</ul>
    			</div>
    			<div class="col-md-4" id="div5.5" style="display:none;">
    				<ul class="accordion">
    					<li>
    						<a>Affine</a>
    						<div class="content">
    							<p>Affine Cipher adalah algoritma kriptografi yang dikembangkan dari metode Caesar Cipher. Algoritma
    								ini merupakan contoh dari kriptografi pertukaran monoalfabet. Affine Cipher melakukan proses
    								enkripsi dengan cara pergeseran karakter dengan substansial matematis.</p>
    						</div>
    					</li>
    					<li>
    						<a>Aturan</a>
    						<div class="content">
    							<p>E(x)=D(x)= (-x mod m) + 1<br><br>Keterangan :<br>E(x): Proses Enkripsi<br>D(x): Proses
    								Dekripsi<br>x : Plainteks atau Cipherteks<br>m : Jumlah Alfabet dari A-Z</p>
    						</div>
    					</li>
    					<li>
    						<a>Komponen</a>
    					...
    					<li>
    						<a>Kelemahan</a>
    						<div class="content">
    							<p>Algoritma ini memiliki kelemahan karena hanya memanfaatkan proses membalikkan posisi karakter yang
    								akan diamankan, hal ini cenderung dapat dengan mudah diretas dan keamanan dat amenjadi kurang
    								maksimal.</p>
    						</div>
    					</li>
    				</ul>
    			...
    			<div class="col-md-4" id="div6.6" style="display:none;">
    				<ul class="accordion">
    					<li>
    						<a>Playfair</a>
    						<div class="content">
    							<p>Playfair cipher atau sering disebut Playfair Square merupakan teknik enkripsi simetrik yang
    								termasuk dalam sistem substitusi digraph. Playfair Cipher Termasuk ke dalam polygram cipher.</p>
    						</div>
    					</li>
    					<li>
    						<a>Aturan</a>
    						<div class="content">
    							<p>- Terdapat 25 buah huruf kunci Kriptografi yang terdapat dalam Playfair Chiper, kunci tersebut
    								disusun didalam bujursangkar 5x5 dengan menghilangkan huruf J dari abjad.<br><br>- Kemudian Susunan
    								kunci (Cipher) dalam bujursangkar diperluas dengan menambahkan baris keenam dan kolom
    								keenam.<br><br>- Kemudian untuk melakukan Enkripsi, Pesan yang akan dienkripsi diatur terlebih
    								dahulu sesuai ketentuan sebagai berikut:<br>* Ganti huruf J (jika ada) dengan huruf I<br>* Tulis
    								pesan dalam pasangan huruf (huruf berpasangan dua-dua / bigram).<br>* Jangan ada pasangan huruf yang
    								sama (misal AA / BB). Jika ada, sisipkan Z di tengahnya<br>* Jika jumlah huruf ganjil (sehingga ada
    					...
    					<li>
    						<a>Kelemahan</a>
    						<div class="content">
    							<p>Kelemahan dari Playfair Cipher yaitu tingkat keamanannya dapat diserang dengan menggunakan teknik
    								frekuensi distribusi huruf ganda pada suatu bahasa.<br><br>Selain itu, Playfair Cipher tidak
