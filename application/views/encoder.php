          ...
          <div class="col-md-4" id="div4.4" style="display:none;">
            <ul class="accordion">
              <li>
                  <a>Transposisi</a>
                  <div class="content">
                      <p>Ciphereteks diperoleh dengan mengubah posisinya. Dengan kata lain, algoritma ini melakukan transpose terhadap rangkaian karakter di dalam teks.</p>
                  </div>
              </li>
              <li>
                  <a>Aturan</a>
